...
public class TimBot { 
  ...
  public static final char TIM_BOT_PERSONALITY = 'N';
  public static final int ENERGY_LEVEL = 99;
  protected char personality;                  // TimBot's personality
  ...
  public TimBot( int id, int jolts ) {
    myId = id;
    energyLevel = jolts;
    personality = TIM_BOT_PERSONALITY;
  }
